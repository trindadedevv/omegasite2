...
import { 
  ...
  Crosshair, Award, Clock, TrendingUp 
} from 'lucide-react';
          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="flex items-center gap-6">
              <div className="hidden md:flex items-center gap-2 px-4 py-2 bg-omega-gray rounded-full border border-omega-gray-light">
                ...
                <span className="font-bold text-omega-white">2.450</span>
                <span className="text-xs text-omega-muted">créditos</span>
              </div>
              
              <div className="flex items-center gap-3 pl-6 border-l border-omega-gray-light">
            ...
            <nav className="space-y-1">
              {sidebarItems.map((item) => (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all font-tech ${
